...
import com.xworkz.functionalInterface.president.PresidentDAO;
import com.xworkz.functionalInterface.president.dto.PresidentDTO;
import com.xworkz.functionalInterface.president.functional.PresidentSearch;

public class PresidentArrival {
	...
	public static void main(String[] args) {
		...
		System.out.println(dao.find((dto1,r)->(dto1.getName()).equalsIgnoreCase(r), "Rumen Radev"));
		System.out.println(dao.find((dto2,r)->(dto2.getCountry()).equalsIgnoreCase(r), "India"));
		System.out.println(dao.find((dto3,r)->Integer.parseInt(dto3.getAge())>Integer.parseInt(r), "50"));
		System.out.println(dao.find((dto4,r)->(dto4.getLanguage()).equalsIgnoreCase(r), "Hindi"));
